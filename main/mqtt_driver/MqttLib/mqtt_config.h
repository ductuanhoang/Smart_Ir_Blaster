...
#define MQTT_QUEUE_BUFFER_SIZE_WORD 1300
#define MQTT_BUFFER_SIZE_BYTE       1300
...
#define MQTT_TASK_STACK             (6*MQTT_BUFFER_SIZE_BYTE)
#define MQTT_KEEPALIVE_TICK         (120)
#define MQTT_BUFFER_SIZE            (1*MQTT_BUFFER_SIZE_BYTE)
